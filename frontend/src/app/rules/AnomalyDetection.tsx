...
import { initialConditions, LOGIC_OPERATORS, OPERATORS, RiskLevel, type RuleCondition } from "@/models/RiskLevelModel";
...
export const AnomalyDetection = ({ onConfigChange }: AnomalyDetectionProps) => {
